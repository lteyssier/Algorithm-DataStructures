...
Linked Lists consists of nodes,and each node has a value and a pointer to another
node or null 
*/
...
-Can quicklu be accessed at a specific index
*/
...
-If there is no head property on the list, set the head and the tail to be the
newly created node
-Otherwise set the next property on the tail to be the new node and set the tail 
property con ths list to be the newly created node
-Increment the lenght by one
-Return the linkedt list
*/

//Popping
/*Removing a node fromo the end of the Linked list*/
/*Popping pseudocode
...
-Store the curren head property in a variable
...
//Set
//Changing de value of a node based on it's position in the Linked List
/*Set pseudocode
...
//Insert
/*Insert pseudocode 
-If the indes is less than zero or greater than the length, return false
-If the index is the same as the length, push a new node to the end of the list
-If the index is 0, unshift a new node to the start of the list
-Otherwise, using the get method, access the node at the index -1
-Set the next property on that node to be the new node
-Set the next property on the new node to tbe the previous next
-Increment the length
-Return true
*/

//Remove intro
/*Remove intro pseudocode
-If the index is less than zero or greater than the length, return undefined
-If the index is the same as the length-1,pop
-If the index is 0, shift
-Otherwise, using the get method, access the node at the index -1
-Set the next property on that node to be the next of the nex node
...
console.log(list.push("hight"))
console.log(list.push("everyone"))
console.log(list.push("jedis"))
console.log(list.pop())
console.log(list.shift())
console.log(list.unshift("Hello"))
console.log(list.get(2))
console.log(list.set(1,"General Kenobi"))
console.log(list.insert(0,"Hello there"))
